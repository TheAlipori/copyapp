...
import { Calendar, Timer, Settings, X, Receipt, Banknote, ArrowRight, Layers, Printer, GripVertical, Copy, Check } from 'lucide-react';
import {
...
function CopyWhatsApp({ numero }: { numero: string }) {
  ...
  return (
    <div className="flex items-center gap-1.5">
      <p className="font-semibold text-gray-800 text-base leading-tight">{numero}</p>
      <button type="button" onClick={copiar} title="Copiar número"
...
function imprimirPendiente(p: Pendiente) {
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .titulo { text-align: center; font-size: 22px; font-weight: bold; letter-spacing: 1px; margin-bottom: 2px; }
    .folio { text-align: center; font-size: 20px; margin-bottom: 2px; }
    .fecha-reg { text-align: center; font-size: 16px; color: #555; margin-bottom: 8px; }
    hr { border: none; border-top: 1px dashed #000; margin: 8px 0; }
    .row { display: flex; justify-content: space-between; margin-bottom: 5px; font-size: 19px; }
    .label { color: #555; flex-shrink: 0; margin-right: 8px; }
    .value { font-weight: bold; text-align: right; }
    .instrucciones { font-size: 19px; margin-top: 4px; padding: 6px; border: 1px dashed #aaa; }
    .instrucciones-label { font-size: 16px; color: #555; margin-bottom: 3px; }
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      <div className="min-w-0">
        <CopyWhatsApp numero={p.whatsapp} />
